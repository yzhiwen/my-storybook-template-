...
export default function () {
    ...
    const initGLSL = (gl: WebGLRenderingContext | any) => {
        ...
        // gl.point = new Line(-1, -1, -1, 30, 30, 30);
    }
    ...
    const drawModel = (gl: WebGLRenderingContext | any) => {
        ...
        const d = endPoint.clone().subtract(startPoint).normalize()
        // matrixModel.lookAt(d.x, d.y, d.z);
        matrixModel.translate(endPoint.x, t.y, t.z);
        ...
        const cylinerVertices = twgl.primitives.createCylinderVertices(0.01, 10, 10, 1);
        console.log('>>>>cylinerVertices', cylinerVertices)
        const bufferInfo_ = twgl.createBufferInfoFromArrays(gl, {
            vertexPosition: cylinerVertices['position']!,
            indices: cylinerVertices['indices']!,
        })
